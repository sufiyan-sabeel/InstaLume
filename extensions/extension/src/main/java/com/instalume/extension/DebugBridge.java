...
/**
 * Development-only ADB bridge: drives InstaLume's settings from a shell instead
 ...
 *
 * <pre>
 * adb shell am broadcast -p com.instagram.android -a com.instalume.debug.DUMP
 * adb shell am broadcast -p com.instagram.android -a com.instalume.debug.SET \
 *     --es key block_ads --ez value true
 * adb shell am broadcast -p com.instagram.android -a com.instalume.debug.SET \
 *     --es key landing_page --es value search
 * adb shell am broadcast -p com.instagram.android -a com.instalume.debug.NAV
 * adb shell am broadcast -p com.instagram.android -a com.instalume.debug.TRACE --ez value true
 * adb shell am broadcast -p com.instagram.android -a com.instalume.debug.UPDATE
 * adb shell am broadcast -p com.instagram.android -a com.instalume.debug.WHATSNEW
 * adb shell am broadcast -p com.instagram.android -a com.instalume.debug.RESET
 * adb shell am broadcast -p com.instagram.android -a com.instalume.debug.RESTART
 * </pre>
 *
...
public final class DebugBridge {
    ...
    public static final String TAG = "InstaLumeDebug";

    private static final String PREFIX = "com.instalume.debug.";
    ...
    private static String handle(Context context, String command, Intent intent) {
        switch (command) {
            ...
            case "TRACE":
                ...
                return "network trace " + (sNetworkTrace ? "on (logcat -s InstaLumeNet:I)" : "off");
            case "RESET":
                return reset();
            case "RESTART":
