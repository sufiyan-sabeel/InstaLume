...
public final class Block {
     ...
     */
    private static final String INVALID_FEED_TYPE = "instalume_blocked";
    ...
    public static void throwIfBlocked(URI uri) throws IOException {
        ...
        if (DebugBridge.isNetworkTraceEnabled()) Log.i("InstaLumeNet", path);
    ...
    public static String replaceFeedItemType(String key) {
        ...
        if (DebugBridge.isNetworkTraceEnabled()) {
            Log.i("InstaLumeFeed", (drop ? "drop " : "keep ") + key);
        }
    ...
    private static IOException blocked() {
        return new IOException("Blocked by InstaLume");
    }
}
